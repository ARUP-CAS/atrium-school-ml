...
The detailed programme is under preparation and will be published by mid-March(?)

The initial idea goes along these lines:

1. Python for computer vision tasks
2. Dataset creation, basic computer vision tasks and datasets, formats etc.
3. Image pre-processing
4. Training 
5. Post-processing and advanced topics
:::
...
::: {.callout-note}
We'll meet [here](https://maps.app.goo.gl/befsDeAF1yLgjCrt9) at 9:30 AM. 
:::
