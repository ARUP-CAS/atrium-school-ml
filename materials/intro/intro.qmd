...
If you have nothing to hand, think about one of the datasets we are going to work with this week.
:::
:::
...
You know the vocabulary of detection and classification.
:::

::: {.aside}
Pre-school survey, n = 29.
:::
...
and **19%** rate their Python 4 or 5 out of 5.
:::
...
::: {.smaller}
Annotation is probably the single largest cost in every project we will look at, and the
...
> and micro-topographical anomalies, **drastically reducing the manual processing time**. (Árpád)

> Better understand the **inner workings** of a machine learning model, by learning
> to develop and train it myself. (Aaricia)

> Even if I don't have a large corpus, I would like to **test AI methods on my
> dataset** by the end of the week. (Hüseyin)
:::
::::

::: {.aside}
Artefact photographs and satellite imagery seem to draw the
...
::: {.figure .figure-lg}
![](img/image-as-array.png){fig-alt="A terra sigillata sherd, a 36 by 36 pixel window of it, and an 8 by 8 grid of the red-channel values."}

[Sherd: AMČR [M-202300130-N00020](https://doi.org/10.71928/M-202300130-N00020), CC BY-NC 4.0]{.credit}
:::

::: {.smaller}
A 4000 × 3000 photograph of a sherd is 12 million numbers per colour channel — 36 million in all.
Nothing in that array says *sherd*, *terra sigilata*, or *Roman period*.
:::
...
::: {.figure}
![](img/semantic-gap.png){fig-alt="The same sherd as a colour photograph and as a map of brightness gradients."}
...
- a sherd, wheel-thrown
- Roman,terra sigilata -- Rheinzabern
...
::: {.figure}
![](img/data-deluge.jpg){fig-alt="An aerial photograph of vegetation marks in a field, an excavation trench being photographed from above, and a 1984 archive photograph of a burial in a circular pit."}

[M. Gojda, AMČR [C-DL-201000159](https://doi.org/10.60585/C-DL-201000159); N. Profantová, AMČR [C-200913914A-DT-05281](https://doi.org/10.60585/C-200913914A-DT-05281); AMČR [M-FT-900144861](https://doi.org/10.60585/M-FT-900144861) (1984); CC BY-NC 4.0]{.credit}
:::
...
::: {.column width="25%"}
::: {.figure}
![](img/task-classification.jpg){fig-alt="A Roman bronze coin with the single label coin."}
:::
**Classification**
...
::: {.column width="25%"}
::: {.figure}
![](img/task-detection.jpg){fig-alt="Twenty-four potsherds on graph paper, each inside a bounding box."}
:::
**Detection**
...
::: {.column width="25%"}
::: {.figure}
![](img/task-segmentation.jpg){fig-alt="A rosary with its chain, loose beads and cross each covered by a coloured mask."}
:::
**Segmentation**
...
::: {.column width="25%"}
::: {.figure}
![](img/task-keypoints.png){fig-alt="A vessel profile drawing with landmarks at the rim, neck, maximum diameter, base and base centre."}
:::
**Keypoints**
...
::: {.aside}
Photographs: Z. Omelka, AMČR [M-202101534-N00243](https://doi.org/10.71928/M-202101534-N00243);
M. Martinek, AMČR [M-202300087-N00510](https://doi.org/10.71928/M-202300087-N00510);
J. Machan, AMČR [M-202400071-N00083](https://doi.org/10.71928/M-202400071-N00083); CC BY-NC 4.0.
Boxes and masks from the AMČR-PAS annotations.
:::
...
|---|---|
| **Classification** | decorated ceramic typology from photographs [@pawlowicz2021] |
...
| **Segmentation** | hollow roads traced in LiDAR [@verschoofvan2021]; agrarian field systems from satellite imagery [@kucukdemirci2025] |
| **Keypoints** | tracing a knapper's movements, the motor side of knapping skill [@pargeter2022] |
...
::: {.figure}
![](img/pipeline.png){fig-alt="Six stages in a row: question, data and annotation, pre-processing, training, evaluation, interpretation. The first two are highlighted."}
:::
...
::: {.column width="49%"}
::: {.figure}
![](img/decision-boundary.png){fig-alt="Two clusters of points, Neolithic and Iron Age, separated by a straight blue line."}
:::
::: {.box .box-disc}
...
::: {.column width="49%"}
::: {.figure}
![](img/density.png){fig-alt="The same two clusters with orange density contours around each, and a few new points sampled from them."}
:::
::: {.box .box-gen}
...
::: {.figure .figure-sm}
![](img/discriminative.png){fig-alt="A sherd photograph goes into a model, which returns a label, a bounding box, or a mask."}
...
::: {.figure}
![](img/gen-restoration.jpg){fig-alt="Two damaged medieval frescoes, each next to a version in which a neural network has filled in the missing paint."}

[Merizzi et al. 2024, *Heritage Science* 12, 41, Figs. 12 & 17, [doi:10.1186/s40494-023-01116-x](https://doi.org/10.1186/s40494-023-01116-x), CC BY 4.0, modified]{.credit}
:::
...
On the frescoes: ask the room which pixels in the "inpainted" panels are evidence.
None of the filled areas are — they are the network's guess at what paint was there.
:::
...
::: {.aside}
Notebook: `1-monday-intro/clip_zero_shot.ipynb` (alternatively `clip_zero_shot_v2.ipynb`) in the lessons repository.
:::
...
::: {.figure .figure-sm}
![](img/clip-output.png){fig-alt="CLIP output for two sherds. Terra sigillata with five sensible labels: 95% potsherd. A coarse sherd with the same labels: 51% potsherd, 48% stone tool. The coarse sherd offered only coin, stone tool and bicycle: stone tool at 100%."}

[Sherds: AMČR [M-202300130-N00020](https://doi.org/10.71928/M-202300130-N00020); M. Španěl, AMČR [M-202300087-N00486](https://doi.org/10.71928/M-202300087-N00486); CC BY-NC 4.0]{.credit}
:::
...
Notebooks and datasets: [github.com/arubrno/atrium-school-ml-lessons](https://github.com/arubrno/atrium-school-ml-lessons) ·
