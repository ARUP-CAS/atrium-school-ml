...
::: {.aside}
Notebook: `1-monday-intro/clip_zero_shot.ipynb` in the lessons repository, on the [CERIT-SC JupyterHub](https://docs.cerit.io/en/docs/web-apps/jupyterhub){.external}.
:::
