...
::: {.figure .figure-xl}
![](img/annotation-levels.jpg){fig-alt="One photograph of a rosary at four levels of annotation: an image-level label, ten bounding boxes, ten filled polygons, and the polygons with an attribute panel listing recognizable, occluded, and three unanswered fields."}
...
2. Read its labelling config out loud — the classes and the three checkboxes
...
::: {.column width="54%"}
::: {.incremental}
1. Open the URL on the board and sign in with the name on your badge
2. You have **10 photographs** from AMČR-PAS
3. For each: draw a **box** around each artefact, pick a **class**, tick the **attributes**
...
::: {.notes}
Write the URL on the board before the session starts. Walk the room; note out loud
which images people hesitate on — those are the ones to pull up in the next block.
...
- The **attributes** will be all over the place, because *complete* and *corroded* are
  judgements and nobody defined them for you
:::
...
::: {.notes}
Pick the two planted ambiguous images. Ask the people who disagreed to say why —
out loud, without defending themselves. The answers are always about the *definition*,
never about the photograph.
:::
...
- Along the way you answer the easy questions: *complete? corroded? is there a scale?*
